...
function getSign(e, t, a) {
    var n = require("7499EE951B34E4DF12FF8692C0B6A052.js"), r = require("65C461061B34E4DF03A209015CB6A052.js"), i = "", s = getUrlParam(e, "sign");
    ...
    g < i.length - 1 && (c += "&"));
    return r(c + (a = a || getApp().siteInfo.token));
}

var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault.js"), _typeof2 = _interopRequireDefault(require("@babel/runtime/helpers/typeof.js")), _base = require("7F2203A11B34E4DF19446BA6CF86A052.js"), _md = _interopRequireDefault(require("65C461061B34E4DF03A209015CB6A052.js")), util = {
    ...
    getSign: function(e, t, a) {
        return getSign(e, t, a);
    },
    request: function(e) {
        var t;
        require("7499EE951B34E4DF12FF8692C0B6A052.js");
        var a = require("65C461061B34E4DF03A209015CB6A052.js"), n = getApp();
        ...
        wx.request((_defineProperty(t = {
            ...
            var a = require("65C461061B34E4DF03A209015CB6A052.js")(i), n = wx.getStorageSync(a);
...
util.user = util.getUserInfo, util.showLoading = function() {
    ...
    this.isLeapYear = function(e) {
        ...
        var a = e;
        return (a = (a = (a = (a = (a = (a = (a = (a = (a = (a = (a = (a = a.replace(/yyyy|YYYY/, t.getFullYear())).replace(/yy|YY/, t.getYear() % 100 > 9 ? (t.getYear() % 100).toString() : "0" + t.getYear() % 100)).replace(/MM/, t.getMonth() > 9 ? t.getMonth() + 1 : "0" + (t.getMonth() + 1))).replace(/M/g, t.getMonth())).replace(/w|W/g, [ "日", "一", "二", "三", "四", "五", "六" ][t.getDay()])).replace(/dd|DD/, t.getDate() > 9 ? t.getDate().toString() : "0" + t.getDate())).replace(/d|D/g, t.getDate())).replace(/hh|HH/, t.getHours() > 9 ? t.getHours().toString() : "0" + t.getHours())).replace(/h|H/g, t.getHours())).replace(/mm/, t.getMinutes() > 9 ? t.getMinutes().toString() : "0" + t.getMinutes())).replace(/m/g, t.getMinutes())).replace(/ss|SS/, t.getSeconds() > 9 ? t.getSeconds().toString() : "0" + t.getSeconds())).replace(/s|S/g, t.getSeconds());
