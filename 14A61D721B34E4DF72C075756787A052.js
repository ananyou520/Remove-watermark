var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault.js"), _defineProperty2 = _interopRequireDefault(require("@babel/runtime/helpers/defineProperty.js")), _typeof2 = _interopRequireDefault(require("@babel/runtime/helpers/typeof.js")), _base = require("2B3D25F11B34E4DF4D5B4DF6D247A052.js"), _md = _interopRequireDefault(require("DC8637471B34E4DFBAE05F40B767A052.js")), util = {};
...
function getSign(e, t, a) {
    var n = require("18C5C4961B34E4DF7EA3AC91D477A052.js"), r = require("DC8637471B34E4DFBAE05F40B767A052.js"), i = "", s = getUrlParam(e, "sign");
...
util.base64_encode = function(e) {
    ...
    require("18C5C4961B34E4DF7EA3AC91D477A052.js");
    var t, a = require("DC8637471B34E4DFBAE05F40B767A052.js"), n = getApp();
    ...
    if (wx.showNavigationBarLoading(), e.showLoading && util.showLoading(), e.cachetime) {
        var u = a(i), c = wx.getStorageSync(u), f = Date.parse(new Date());
        if (c && c.data) {
    ...
    wx.request((t = {
        ...
        var a = require("DC8637471B34E4DFBAE05F40B767A052.js")(i), n = wx.getStorageSync(a);
    ...
    this.isLeapYear = function(e) {
        ...
        return a = (a = (a = (a = (a = (a = (a = (a = (a = (a = (a = (a = (a = a.replace(/yyyy|YYYY/, t.getFullYear())).replace(/yy|YY/, t.getYear() % 100 > 9 ? (t.getYear() % 100).toString() : "0" + t.getYear() % 100)).replace(/MM/, t.getMonth() > 9 ? t.getMonth() + 1 : "0" + (t.getMonth() + 1))).replace(/M/g, t.getMonth())).replace(/w|W/g, n[t.getDay()])).replace(/dd|DD/, t.getDate() > 9 ? t.getDate().toString() : "0" + t.getDate())).replace(/d|D/g, t.getDate())).replace(/hh|HH/, t.getHours() > 9 ? t.getHours().toString() : "0" + t.getHours())).replace(/h|H/g, t.getHours())).replace(/mm/, t.getMinutes() > 9 ? t.getMinutes().toString() : "0" + t.getMinutes())).replace(/m/g, t.getMinutes())).replace(/ss|SS/, t.getSeconds() > 9 ? t.getSeconds().toString() : "0" + t.getSeconds())).replace(/s|S/g, t.getSeconds());
        ...
        var t = e.getTime() - 864e5, a = new Date(t);
        return a.getDate();
    };
}, module.exports = util;